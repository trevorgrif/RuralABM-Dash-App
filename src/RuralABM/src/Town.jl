...
:SIC code as SIC_vector in the metagraph (Graph) tp new_type.
...
function add_business_structure!(Graph, Main_Sheet)
    ...
    select!(Main_Sheet,[:CONAME,:SIC,:EMPNUM])
